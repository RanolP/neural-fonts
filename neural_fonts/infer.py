...
parser.add_argument(
    "--embedding_ids", default="embedding_ids", type=str, help="embeddings involved"
)
parser.add_argument(
    "--save_dir", default="save_dir", type=str, help="path to save inferred images"
)
parser.add_argument(
    "--inst_norm",
    dest="inst_norm",
