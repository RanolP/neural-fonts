...
def draw_example(
    ch, src_font, dst_font, canvas_size, src_offset, dst_offset, filter_hashes
):
...
parser.add_argument(
    "--src_font", dest="src_font", required=True, help="path of the source font"
)
parser.add_argument(
    "--dst_font", dest="dst_font", required=True, help="path of the target font"
)
parser.add_argument(
    "--filter", dest="filter", type=int, default=0, help="filter recurring characters"
)
parser.add_argument(
    "--shuffle",
    dest="shuffle",
...
parser.add_argument(
    "--char_size", dest="char_size", type=int, default=80, help="character size"
)
parser.add_argument(
    "--canvas_size", dest="canvas_size", type=int, default=128, help="canvas size"
)
parser.add_argument(
    "--x_offset", dest="x_offset", type=int, default=27, help="x offset"
)
parser.add_argument(
    "--y_offset", dest="y_offset", type=int, default=16, help="y_offset"
)
parser.add_argument(
    "--sample_count",
    dest="sample_count",
...
parser.add_argument(
    "--sample_dir", dest="sample_dir", help="directory to save examples"
)
parser.add_argument(
    "--label", dest="label", type=int, default=0, help="label as the prefix of examples"
)
parser.add_argument(
    "--fixed_sample",
    dest="fixed_sample",
    type=int,
    default=0,
    help="pick fixed samples (399 training set, 500 test set). Note that this should not be used with --suffle.",
)
parser.add_argument(
    "--all_sample",
    dest="all_sample",
